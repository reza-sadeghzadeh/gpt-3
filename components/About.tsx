    ...
    <section className="gp3-container my-16">
      <div className="relative lg:p-16 p-12  bg-brand-lightBlue/75 overflow-hidden">
        <div
          ...
          className="absolute  rounded-full opacity-50 h-96 w-96 -left-48 -top-80  bg-brand-blueShadow/50"
        />
        <div
          style={{
            boxShadow: "rgb(27 120 222 / 60%) 0px 0px 100px 60px",
          }}
          className="absolute  rounded-full opacity-40 h-96 w-96 -right-40 -bottom-48  bg-brand-blueShadow/50"
        />
        <GradLine />
